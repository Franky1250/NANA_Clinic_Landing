...
const HeroLanding = () => {
  ...
  return (
    <section id="services" className="pt-32 pb-20 overflow-hidden">
      {/* Hero Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h1
            className="text-4xl md:text-5xl lg:text-6xl font-bold text-clinic-accent leading-tight reveal"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-16">
          {[
            ...
            <div
              key={index}
              className="flex items-start space-x-3 reveal px-4 py-3 rounded-lg hover:bg-white/50 transition-all duration-300"
        ...
        <div className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-clinic-accent mb-16 reveal">
            Our <span className="text-clinic-primary">3-Step</span> Process
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                image: "/images/treating-a-patient-2.jpg",
                delay: "600ms"
              },
              {
                title: "3",
